...
export function Dashboard() {
  ...
  return (
    <div className="p-4 md:p-8 flex flex-col gap-6 md:gap-8 max-w-7xl mx-auto">
      ...
      <div className="bg-red-50 p-4 md:p-6 rounded-2xl shadow-sm border border-red-100 flex items-center justify-between cursor-pointer hover:bg-red-100 transition-colors" onClick={() => router.push('/products')}>

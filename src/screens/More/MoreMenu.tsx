...
import { History, Users, PieChart, LogOut, ChevronRight, BarChart2 } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto w-full flex flex-col gap-6">
        <div className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm md:text-base capitalize">{currentUser?.role === 'admin' ? 'Administrador' : 'Funcionário'}</p>
          </div>
        </div>
